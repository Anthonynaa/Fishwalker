...
Monster* MonsterFactory::createInfectedMonster() const {
  return new InfectedMonster(
      "Infected Fishwalker", INFECTED_MONSTER_ID, INFECTED_MONSTER_HP,
      INFECTED_MONSTER_MAX_HP, INFECTED_MONSTER_ATK, INFECTED_MONSTER_ACC,
      INFECTED_MONSTER_AGL, INFECTED_MONSTER_RES, INFECTED_MONSTER_INF,
      INFECTED_MONSTER_CRIT, INFECTED_MONSTER_INFECTION_POWER);
}
